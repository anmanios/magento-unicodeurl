...
class Anmanios_Unicodeurl_Model_Catalog_Product_Url extends Mage_Catalog_Model_Product_Url
{
    ...
    public function formatUrlKey($str)
    {
		...
		$urlKey = preg_replace('#[ ]+#i', '-', Mage::helper('catalog/product_url')->format($str));
